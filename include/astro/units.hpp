...
struct solar
{
    ...
    static constexpr realT length =
        static_cast<realT>( 1 ) / constants::au<si<realT>>(); ///< Conversion from SI (m) to solar (au)
    static constexpr realT time =
        static_cast<realT>( 1.0 ) / constants::year<si<realT>>(); ///< Conversion from SI (s) to solar (yr)
    static constexpr realT mass =
        constants::G<si<realT>>() / constants::GMSun<si<realT>>(); ///< Conversion from SI (kg) to solar (M_sun)
    static constexpr realT energy =
        static_cast<realT>( 1.0 ) /
        ( constants::lumSun<si<realT>>() * static_cast<realT>( 365.25 ) *
          static_cast<realT>( 86400.0 ) ); ///< Conversion from SI (J) to  solar (Solar-luminosities X year)
    static constexpr realT temperature =
        static_cast<realT>( 1.0 ) / constants::TeffSun<si<realT>>(); ///< Conversion from SI (K) to solar (5772 K)
};
...
struct earth
{
    typedef _realT realT; ///< The real floating point type in which to specify constants.
    static constexpr realT length =
        static_cast<realT>( 1 ) / constants::radEarth<si<realT>>(); ///< Conversion from SI (m)
    static constexpr realT time = static_cast<realT>( 1.0 );        ///< Conversion from SI (s)
    static constexpr realT mass =
        static_cast<realT>( 1.0 ) / constants::massEarth<si<realT>>(); ///< Conversion from SI (kg)
...
struct jupiter
{
    typedef _realT realT; ///< The real floating point type in which to specify constants.
    static constexpr realT length =
        static_cast<realT>( 1 ) / constants::radJupiter<si<realT>>(); ///< Conversion from SI (m)
    static constexpr realT time = static_cast<realT>( 1.0 );          ///< Conversion from SI (s)
    static constexpr realT mass =
        static_cast<realT>( 1.0 ) / constants::massJupiter<si<realT>>(); ///< Conversion from SI (kg)
    static constexpr realT energy = static_cast<realT>( 1.0 );           ///< Conversion from SI (J)
    static constexpr realT temperature = static_cast<realT>( 1.0 );      ///< Conversion from SI (K)
};
