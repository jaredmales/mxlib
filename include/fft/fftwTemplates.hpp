...
template<>
inline void fftw_execute_dft<complexFT,float>( fftwTypeSpec<complexFT,float>::planT plan, 
                                               complexFT * in,
                                               float * out 
                                             )
{
...
template<>
inline void fftw_execute_dft<complexDT, double>( fftwTypeSpec<complexDT,double>::planT plan, 
                                                 complexDT * in, 
                                                 double * out
                                               )
{
