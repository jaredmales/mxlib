...
void gramSchmidtSpectrum( eigenTout &out,                         ///< [out] the orthonormal basis set constructed from the input
                          ...
                          typename eigenTin::Scalar normPix = 0.0 /**< [in] [optional] area of (usually number of pixels in) the orthogonal region 
                                                                    *                  for normalization.  If 0 the basis is not renormalized */
                        )
{
