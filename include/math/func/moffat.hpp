...
/** \addtogroup gen_math_moffats
  ...
  *
  * 1-D and 2-D symmetric forms are provided.  Utilities are provided for normalizing and calculating the full-width at
  half-maximum.
  */
...
extern template double moffat<double>(
    const double x, const double I0, const double Ipk, const double x0, const double alpha, const double beta );

extern template long double moffat<long double>( const long double x,
...
extern template float moffat2D<float>( const float x,
                                       const float y,
                                       const float I0,
                                       const float Ipk,
                                       const float x0,
...
extern template double moffat2D<double>( const double x,
                                         const double y,
                                         const double I0,
                                         const double Ipk,
                                         const double x0,
...
extern template long double moffat2D<long double>( const long double x,
                                                   const long double y,
                                                   const long double I0,
                                                   const long double Ipk,
                                                   const long double x0,
...
extern template float moffatFWHM( float alpha, float beta );
