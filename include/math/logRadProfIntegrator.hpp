...
typename interpT::realT logRadProfIntegrationF ( typename interpT::realT x, 
                                                 void * params
                                               )
{
...
/** Useful for steep power-law like functions like power-spectra
  ...
  */
template<typename interpT>
typename interpT::realT logRadProfIntegrator( const std::vector<typename interpT::realT> & x, ///< [in] the x values of the function.  Must be positive definite (can not contain 0).
                            const std::vector<typename interpT::realT> & y, ///< [in] the y values of the function.  Must be positive definite (can not contain 0).
