# Makefile for building mxlib based applications when cmake was used to build it
#
# Note: this does not use cmake, but relies on the pkgconfig file installed by cmake
...
$(TARGETNAME): $(OBJNAME) $(OTHER_OBJS)
	$(LINK.o)  -o $(TARGETNAME) $(OBJNAME) $(OTHER_OBJS) $(MXLIB_LIBS) $(OTHER_LIBS)
