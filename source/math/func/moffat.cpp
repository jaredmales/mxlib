...
template float moffat2D<float>( const float x,
                                const float y,
                                const float I0,
                                const float Ipk,
                                const float x0,
...
template double moffat2D<double>( const double x,
                                  const double y,
                                  const double I0,
                                  const double Ipk,
                                  const double x0,
...
template long double moffat2D<long double>( const long double x,
                                            const long double y,
                                            const long double I0,
                                            const long double Ipk,
                                            const long double x0,
