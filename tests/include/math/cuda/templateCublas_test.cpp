...
SCENARIO( "scaling a vector with cublas", "[math::cuda::templateCublas]" ) 
{
   GIVEN("a vector")
   {
      WHEN("type is single precision real")
      {
         ...
         hx.resize(5);
         for(size_t n=0; n < hx.size(); ++n) hx[n] = n;
      ...
      WHEN("type is single precision complex")
      {
         ...
         hx.resize(5);
         for(size_t n=0; n < hx.size(); ++n) hx[n] = std::complex<float>(n,n);
      ...
      WHEN("type is double precision complex")
      {
         ...
         hx.resize(5);
         for(size_t n=0; n < hx.size(); ++n) hx[n] = std::complex<double>(n,n);
...
SCENARIO( "scaling and accumulating a vector with cublas", "[math::cuda::templateCublas]" ) 
{
   GIVEN("a vector")
   {
      WHEN("type is single precision real")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = 1;
      ...
      WHEN("type is single precision complex")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = std::complex<float>(1,1);
      ...
      WHEN("type is double precision complex")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = std::complex<double>(1,1);
...
SCENARIO( "multiplying two vector element by element", "[math::cuda::templateCublas]" ) 
{
   GIVEN("a vector")
   {
      WHEN("both types are single precision real")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = 2*n;
      ...
      WHEN("type1 is complex-float, and type2 is complex-float")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = std::complex<float>(0,2*n);
      ...
      WHEN("type1 is complex-double, and type2 is complex-double")
      {
         ...
         hy.resize(5);
         for(size_t n=0; n < hy.size(); ++n) hy[n] = std::complex<double>(1,2*n);
