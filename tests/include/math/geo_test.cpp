...
SCENARIO( "Verify compilation and calculations of math::angleDiff", "[math::angleDiff]" ) 
{
   ...
   GIVEN("angles in radians")
   {
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(0.0),mx::math::dtor<double>(43.2));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(43.2),mx::math::dtor<double>(0.0));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(360.0),mx::math::dtor<double>(43.2));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(43.2),mx::math::dtor<double>(360.0));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(340.0),mx::math::dtor<double>(23.2));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(23.2),mx::math::dtor<double>(340.0));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(160.0),mx::math::dtor<double>(206.2));
      ...
      {
         double q = mx::math::angleDiff<mx::math::radiansT<double>>(mx::math::dtor<double>(206.2),mx::math::dtor<double>(160.0));
